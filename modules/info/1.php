...
?>    
    <div id="page-heading">
        ...
        <h1><?php echo $row['name']; ?> - <?php echo $row['uid']; ?> - Last save: <?php echo $row['lastupdate']; ?></h1>
    </div>
    <!-- end page-heading -->
